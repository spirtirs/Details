...
L["STRING_ATTRIBUTE_DAMAGE_DPS"] = "ДПС"
...
L["STRING_ATTRIBUTE_HEAL_HPS"] = "ХПС"
...
L["STRING_CUSTOM_ATTRIBUTE_HEAL"] = "ХПС"
...
L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET"] = "Наносимый урон по меткам"
...
L["STRING_CUSTOM_DAMAGEONSKULL"] = "Наносимый урон по метке с черепом"
...
L["STRING_CUSTOM_TEXTURE_GUIDE"] = "Чтобы загрузить файл текстуры в клиент World of Warcraft, вам нужен файл в формате .TGA, а также его ширина и высота должны быть кратны 8. Поместите текстуру в папку /место установленного клиента PandaWoW/Interface/"
...
L["STRING_HEALING_HPS_FROM"] = "ХПС, полученное от"
...
L["STRING_OPTIONS_BARUR_DESC"] = "Когда включено, то значения, ДПС и ХПС обновляются немного быстрее, чем обычно."
L["STRING_OPTIONS_BG_ALL_ALLY"] = "Поле БГ показывать все"
...
L["STRING_OPTIONS_DATABROKER_TEXT_ADD2"] = "ДПС Игрока (эффективность)"
...
L["STRING_OPTIONS_DATABROKER_TEXT_ADD6"] = "ХПС Игрока (эффективность)"
...
L["STRING_OPTIONS_MPLUS_DPS_ANCHOR"] = "Подсчет ДПС по полному сегменту"
...
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT_DESC"] = "ДПС по всему М+ забегу вычисляется по формуле (общий урон)/(общее время боя)."
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME"] = "Время прохождения подземелья"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME_DESC"] = "ДПС по всему М+ забегу вычисляется по формуле (общий урон)/(общее время боя)."
...
L["STRING_OPTIONS_PERFORMANCE_RAID25"] = "Рейд (10-25)"
L["STRING_OPTIONS_PERFORMANCE_RAID40"] = "Рейд (26-40)"
...
L["STRING_OPTIONS_RT_CUSTOM_ANCHOR"] = "Для PandaWoW:"
...
|cFFFFFF00Данные 2|r: в большинстве случаев представляет собой ДПС, ХПС или имя игрока.
...
L["STRING_OPTIONS_TIMEMEASURE_DESC"] = [=[|cFFFFFF00Активный|r: таймер каждого участника рейда ставится на удержание, если их активность прекращается, и снова подсчитывается при возобновлении, общий способ измерения ДПС и ХПС.

|cFFFFFF00Эффективный|r: используется в рейтинге, этот метод использует прошедшее боевое время для измерения ДПС и ХПС - всех участников рейда.]=]
...
L["STRING_PLUGIN_PDPSNAME"] = "Рейдовый ДПС"
...
L["STRING_WELCOME_12"] = "Выберите скорость обновления окна, Вы также можете включить анимацию обновления в режиме реального времени для чисел ХПС и ДПС."
...
L["STRING_WELCOME_3"] = "Выберите предпочитаемый метод ДПС и ХПС:"
...
L["STRING_WELCOME_63"] = "Обновление ДПС/ХПС в реальном времени"
L["STRING_WELCOME_64"] = [=[Когда включено, ДПС и ХПС обновляется очень быстро, не дожидаясь следующего обновления окна.
...
L["Trigger On: "] = "Тип тригера: "
L["Debuff on You"] = "Дебафф на игроке"
L["Debuff on Target"] = "Дебафф на цели"
L["Debuff on Focus"] = "Дебафф на фокусе"
L["Buff on You"] = "Бафф на игроке"
L["Buff on Target"] = "Бафф на цели"
L["Buff on Focus"] = "Бафф на фокусе"
L["Spell Cast Started"] = "Каст начат"
L["Spell Cast Successful"] = "Каст завершен"
L["DBM Time Bar"] = "DBM Таймер"
L["BigWigs Time Bar"] = "BigWings Таймер"
L["Spell Interrupt"] = "Каст Прерван"
L["Spell Dispell"] = "Заклинание развеяно"

L["Trigger Stack Size: "] = "Колво стаков для тригера"
L["Cooldown Animation: "] = "Анимация кулдауна"
L["Encounter ID: "] = "ID подземелья"

L["Cast Duration: "] = "Длина каста"
L["Trigger Remaining Time:"] = "Осталось до каста"
L["Text Size: "] = "Размер текста: "
L["Not Interrupted: "] = "Не сбиваемый: "
L["Title Text: "] = "Текст заголовка: "
L["Spell Name: "] = "Имя заклинания: "
L["Use SpellId: "] ="Использовать ID Закл"
L["Only in Combat: "] = "Только в бою: "
L["Icon: "] = "Иконка: "
L["Play Sound: "] = "Звук: "
L["/Say on Trigger: "] = "Сказать: "
L["Aura Text: "] = "Текст ауры: "
L["Glow Effect: "] = "Свечение"
L["Icon Text: "] = "Текст иконки: "
L["Width/Height: "] = "Размер иконки"
L["Text: "] = "Текст: "
L["Font Size: "] = "Размер текста: "
L["Left Text: "] = "Левый текст: "
L["Bar Width: "] = "Длина бара: "
Примеры: измеритель угроз, анализ ДПС, сводка сражения, создание диаграмм и многое другое.]=]
L["STRING_WELCOME_69"] = "Пропустить"
L["STRING_WELCOME_7"] = "используется для рейтинга, этот метод считывает прошедшее время боя для измерения ДПС и ХПС всех участников рейда."
