...
L["STRING_CUSTOM_ATTRIBUTE_HEAL"] = "HPS"
...
L["STRING_HEALING_HPS_FROM"] = "HPS, полученное от"
...
L["STRING_OPTIONS_BARUR_DESC"] = "Когда включено, то значения, DPS и HPS обновляются немного быстрее, чем обычно."
...
L["STRING_OPTIONS_DATABROKER_TEXT_ADD2"] = "DPS Игрока (эффективность)"
...
L["STRING_OPTIONS_MPLUS_DPS_ANCHOR"] = "Подсчет DPS по полному сегменту"
...
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT_DESC"] = "DPS по всему М+ забегу вычисляется по формуле (общий урон)/(общее время боя)."
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME"] = "Время прохождения подземелья"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME_DESC"] = "DPS по всему М+ забегу вычисляется по формуле (общий урон)/(общее время боя)."
...
|cFFFFFF00Данные 2|r: в большинстве случаев представляет собой DPS, HPS или имя игрока.
...
L["STRING_OPTIONS_TIMEMEASURE_DESC"] = [=[|cFFFFFF00Активный|r: таймер каждого участника рейда ставится на удержание, если их активность прекращается, и снова подсчитывается при возобновлении, общий способ измерения DPS и HPS.

|cFFFFFF00Эффективный|r: используется в рейтинге, этот метод использует прошедшее боевое время для измерения DPS и HPS - всех участников рейда.]=]
...
L["STRING_PLUGIN_PDPSNAME"] = "Рейдовый DPS"
...
L["STRING_WELCOME_12"] = "Выберите скорость обновления окна, Вы также можете включить анимацию обновления в режиме реального времени для чисел HPS и DPS."
...
L["STRING_WELCOME_3"] = "Выберите предпочитаемый метод DPS и HPS:"
...
L["STRING_WELCOME_63"] = "Обновление DPS/HPS в реальном времени"
L["STRING_WELCOME_64"] = [=[Когда включено, DPS и HPS обновляется очень быстро, не дожидаясь следующего обновления окна.
...
Примеры: измеритель угроз, анализ DPS, сводка сражения, создание диаграмм и многое другое.]=]
