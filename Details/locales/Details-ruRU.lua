...
L["STRING_SCORE_BEST"] = "вы набрали |cFFFFFF00%s|r (DPS), это ваши лучшие очки, поздравляю!"
L["STRING_SCORE_BEST_HPS"] = "вы набрали |cFFFFFF00%s|r (HPS), это ваши лучшие очки, поздравляю!"
L["STRING_SCORE_NOTBEST"] = "ваши очки |cFFFFFF00%s|r (DPS), ваш лучший результат был |cFFFFFF00%s|r на %s с %d уровнем предметов."
L["STRING_SCORE_NOTBEST_HPS"] = "ваши очки |cFFFFFF00%s|r (HPS), ваш лучший результат был |cFFFFFF00%s|r на %s с %d уровнем предметов."
...
L["STRING_VERSION_AVAILABLE"] = "Вышла новая версия, скачать её можно в лаунчере либо в https://github.com/PandaWoW-Addons"
...
L["STRING_WELCOME_3"] = "Выберите предпочитаемый метод ДПС ХПС:"
